...
var watchExampleVM = new __WEBPACK_IMPORTED_MODULE_0_Vue___default.a({
  el: '#watch-example',
  data: {
    question: '',
  ...
  methods: {
    getAnswer: __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.debounce(
      function () {
        ...
        var vm = this
        __WEBPACK_IMPORTED_MODULE_2_axios___default.a.get('https://yesno.wtf/api')
          .then(function (response) {
            vm.answer = __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.capitalize(response.data.answer)
          })
